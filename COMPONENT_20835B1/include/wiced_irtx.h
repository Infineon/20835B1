 ...
 *
 ********************************************************************/
#ifndef __WICED_IR_TX_DRIVER_H__
#define __WICED_IR_TX_DRIVER_H__
...
// The following requires FIX_CYW20735B1_210 in patch firmware
#if 1
#define HW_MIA_IR_CTL_EXTEND_IR_BUSY_STATUS_MASK    0x80
/*
 * Hook functions to be invoked before and after running ir tx state machine.
 * Assign
 *   Irtx_processTxData_PreHook  and  Irtx_processTxData_PostHook
 * to your own function to
 * NOTE: Hook functions are invoked in ISR context so be very careful not to
 * run for too long in these functions!
 */
typedef void (*Irtx_processTxData_HookFunc)(IR_TX_STATE state);

extern Irtx_processTxData_HookFunc wiced_irtx_processTxData_PreHook;
extern Irtx_processTxData_HookFunc wiced_irtx_processTxData_PostHook;
extern Irtx_processTxData_HookFunc wiced_irtx_processTxData_CompleteHook;
...
/* @} */
#endif // ifndef __WICED_IR_TX_DRIVER_H__
