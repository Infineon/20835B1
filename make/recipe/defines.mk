...
#
CY_CORE_CFLAGS+=-mfloat-abi=hard -mfpu=fpv4-sp-d16
CY_CORE_EXTRA_LD_FLAGS+=-mfloat-abi=hard -mfpu=fpv4-sp-d16
...
CY_CORE_CGS_ARGS+=-O DLMaxWriteSize:249
else
# Base address
...
ifneq ($(CY_TARGET_DEVICE),20835B1)
...
ifneq ($(CY_OS_DIR),Windows)
  CY_BT_APP_TOOLS_WINDOWS_ONLY=WsOtaUpgrade WMBT
ifneq ($(CY_TARGET_DEVICE),20835B1)
  CY_BT_APP_TOOLS_WINDOWS_ONLY+=MeshClient hello_client
endif
